/*
 * Módulo: mac_int8
 * Descripción: Unidad Multiply-Accumulate de 1 ciclo para inferencia INT8.
 * Estándar: IEEE 1364-2005 (Verilog). Optimizado para Yosys/OpenLane.
 */
...
module mac_int8 (
    ...
    // 1. SEÑALES INTERNAS
    // =========================================================================
    // Multiplicación de 8-bit x 8-bit con signo genera 16 bits
    ...
    // Multiplicación directa (Yosys la inferirá como celdas aritméticas optimizadas)
    assign product = a_in * b_in;

    // Multiplexión de acumulación y extensión de signo implícita ($signed)
